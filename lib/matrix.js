class Matrix {
  ...
  multiply(other) {
    ...
    let matrix = Matrix.createIdentity(this.order)
  ...
  inverse() {
    ...
    let l = lu.L
    let u = lu.U
    let ident = Matrix.createIdentity(this.order)
    let lInv = Matrix.createIdentity(this.order)
    let uInv = Matrix.createIdentity(this.order)
