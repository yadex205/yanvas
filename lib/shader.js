...
Shader.UNIFORMS = {
  ...
  'modelTransformInverse': { type: 'float', size: 4, matrix: true },
  'camPos':                { type: 'float', size: 3, matrix: false },
  'lookAtPos':             { type: 'float', size: 3, matrix: false },
  'projectionTransform':   { type: 'float', size: 4, matrix: true },

  // Material
  'color':                 { type: 'float', size: 4, matrix: false },

  // Texture
  'texture':               { type: 'int',   size: 1, matrix: false }, // sampler2D

  // Light
  'sunDirection':          { type: 'float', size: 3, matrix: false }
}
